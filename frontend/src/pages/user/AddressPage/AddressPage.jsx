                        ...
                        <form>
                            <div className="form-wrapper">
                                <FormElement>
                                    ...
                                    <Input type="text" className="form-elem-control" placeholder="First Name" />
                                </FormElement>
                                <FormElement>
                                    <label htmlFor="" className="form-label font-semibold text-base">
                                        Last Name*
                                    </label>
                                    <Input type="text" className="form-elem-control" placeholder="Last Name" />
                                </FormElement>
                                <FormElement>
                                    <label htmlFor="" className="form-label font-semibold text-base">
                                        Contry / Region
                                    </label>
                                    <Input type="text" className="form-elem-control" placeholder="Country/Region" />
                                </FormElement>
                                <FormElement>
                                    <label htmlFor="" className="form-label font-semibold text-base">
                                        Company Name*
                                    </label>
                                    <Input type="text" className="form-elem-control" placeholder="Company (optional)" />
                                </FormElement>
                                <FormElement>
                                    <label htmlFor="" className="form-label font-semibold text-base">
                                        Street Address*
                                ...
                                <FormElement>
                                    ...
                                    <Input type="text" className="form-elem-control" placeholder="Town / City" />
                                </FormElement>
                                <FormElement>
                                    <label htmlFor="" className="form-label font-semibold text-base">
                                        State*
                                ...
                                <FormElement>
                                    ...
                                    <Input type="text" className="form-elem-control" placeholder="Phone" />
                                </FormElement>
                                <FormElement>
                                    <label htmlFor="" className="form-label font-semibold text-base">
                                        Postal Code*
                                    </label>
                                    <Input type="text" className="form-elem-control" placeholder="Postal Code" />
                                </FormElement>
                                <FormElement>
                                    <label htmlFor="" className="form-label font-semibold text-base">
                            ...
                            <div className="form-btns flex">
                                ...
                                <BaseButtonWhitesmoke type="button">Cancel</BaseButtonWhitesmoke>
                            </div>
                        </form>
                    </UserContent>
                </UserDashboardWrapper>
