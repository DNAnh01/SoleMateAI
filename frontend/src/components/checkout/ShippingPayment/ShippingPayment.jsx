...
import { cardsData } from '~/data/data.mock';
        ...
        <ShippingPaymentWrapper>
            <div className="shipping-addr">
                ...
                <div className="list-group">
                    ...
                    <div className="list-group-item flex items-center">
                        <Input type="radio" name="shipping_addr" />
                        <span className="font-semibold text-lg">Use a different shipping address</span>
                    </div>
                </div>
            </div>
            <div className="shipping-method">
                ...
                <div className="list-group">
                    <div className="list-group-item flex items-center">
                        <span className="font-semibold text-lg">Arrives by Monday, June 7</span>
                    </div>
                    <div className="horiz-line-separator"></div>
                    <div className="list-group-item flex items-start justify-between">
                        <p className="font-semibold text-lg">
                            Delivery Charges &nbsp;
                            <span className="flex text-base font-medium text-gray">Additional fees may apply</span>
                        </p>
                ...
                <div className="list-group">
                    <div className="list-group-item">
                        ...
                        <div className="payment-details">
                            <div className="form-elem-group">
                                <Input type="text" className="form-elem" placeholder="Card number" />
                                <Input type="text" className="form-elem" placeholder="Name of card" />
                            </div>
                            <div className="form-elem-group">
                                <Input type="text" className="form-elem" placeholder="Expiration date (MM/YY)" />
                                <Input type="text" className="form-elem" placeholder="Security Code" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="list-group-item flex items-center">
                        ...
                        <p className="font-semibod text-lg">
                            Cash on delivery
                            <span className="flex text-base font-medium text-gray">Pay with cash upon delivery.</span>
                        </p>
                    </div>
                    <div className="horiz-line-separator"></div>
                    <div className="list-group-item flex items-center">
