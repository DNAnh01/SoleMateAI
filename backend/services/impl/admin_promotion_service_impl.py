...
from backend.schemas.shoe_promotion_schema import (
    ...
    ShoePromotionInDBSchema,
    ShoePromotionUpdateSchema,
)
from backend.schemas.shoe_schema import ShoeOutSchema, ShoeUpdateSchema, ShoeInDBSchema
...
class AdminPromotionServiceImpl(AdminPromotionService):
    ...
    def create_promotion(
        ...
        if 'create_shoe_promotion' not in current_user_role_permission.u_list_permission_name:
            logger.exception(
        ...
        try:
            ...
            for shoe_id in promotion.shoe_ids:
                ...
                brand_found = self.__crud_brand.get(
                    db=db,
                    id=shoe_found.brand_id
                )
                ...
                size_found = self.__crud_size.get(
                    db=db,
                    id=shoe_found.size_id
                )
                ...
                color_found = self.__crud_color.get(
                    db=db,
                    id=shoe_found.color_id
                )
                ...
                updated_shoe = self.__crud_shoe.update_one_by(
                    ...
                    obj_in=ShoeInDBSchema(
                        ...
                        discounted_price=shoe_found.display_price - (shoe_found.display_price * promotion.discount_percent / 100),
                ...
                shoes_out.append(ShoeOutSchema(
                    id=updated_shoe.id,
        ...
        try:
            ...
            for promotion in promotions:
                ...
                shoes_promotions = self.__crud_shoe_promotion.get_multi(
                    db=db,
                    filter_param={"promotion_id": promotion.id}
                )
                for shoe_promotion in shoes_promotions:
                    shoe = self.__crud_shoe.get(
                        db=db,
                        id=shoe_promotion.shoe_id
                    )
                    if shoe is None:
                        return JSONResponse(
                            status_code=400,
                ...
                promotions_out.append(PromotionOutSchema(
                    id=promotion.id,
                    promotion_name=promotion.promotion_name,
                    start_date=promotion.start_date,
                    end_date=promotion.end_date,
            ...
            return JSONResponse(
                ...
                content={
                    "status": 400,
                    "message": "Get all promotion failed"
                }
            )
    ...
    def get_promotion_by_id(
        ...
        try:
            promotion = self.__crud_promotion.get(
                db=db,
                id=promotion_id
            )
    ...
    def update_promotion(
        ...
        try:
            promotion_found = self.__crud_promotion.get(
                db=db,
                id=promotion_id
            )
    ...
    def delete_promotion(
        ...
        if 'delete_promotion' not in current_user_role_permission.u_list_permission_name:
            logger.exception(
        ...
        try:
            ...
            shoes_promotions = self.__crud_shoe_promotion.get_multi(
                db=db,
                filter_param={"promotion_id": promotion_found.id}
            )
            ...
            """delete promotion"""
            deleted_promotion = self.__crud_promotion.remove(
                db=db,
                id=promotion_id
            )
