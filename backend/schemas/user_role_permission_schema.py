...
class UserRolePermissionSchema:
    ...
    class Builder:
        ...
        def with_u_display_name(self, u_display_name: str) -> 'UserRolePermissionSchema.Builder':
        ...
        def with_u_role_name(self, u_role_name: str) -> 'UserRolePermissionSchema.Builder':
            self._u_role_name = u_role_name
            return self
        
        def with_u_list_permission_name(self, u_list_permission_name: list[str]) -> 'UserRolePermissionSchema.Builder':
